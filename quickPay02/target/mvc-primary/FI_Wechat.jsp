...
<%@page import="com.zjf.demo.Pkipair"%>
...
<%
	...
	String ext2 = "扩展2";
	//支付方式，一般为00，代表所有的支付方式。微信公众号直连传26-1
	String payType = "26-1";
	...
	String pid = "";
	//聚合支付参数
	String aggregatePay="26-1:[appId=wx089ce5449255261e,openId=oHcey01Os9xM-oxltNKEsTnqZZFk,limitPay=0]";
...
<html>
	...
	<body>
		...
		<div align="center" style="font-weight: bold;">
			<form name="kqPay" action="https://sandbox.99bill.com/mobilegateway/recvMerchantInfoAction.htm" method="get">
